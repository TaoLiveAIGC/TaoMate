...
_GEMMA_VISION_TOWER_SENTINEL = "__ltx_gemma_vision_tower__."
...
GEMMA_LLM_KEY_OPS = (
    ...
    .with_replacement("vision_tower.vision_model.", _GEMMA_VISION_TOWER_SENTINEL)
    .with_replacement("vision_tower.", _GEMMA_VISION_TOWER_SENTINEL)
    .with_replacement(_GEMMA_VISION_TOWER_SENTINEL, "model.model.vision_tower.")
